...
class Elog extends CI_Model{
    ...
    public function viewAllLog($orderBy, $orderFormat, $start=0, $limit=''){
        $this->db->limit($limit, $start);
        $this->db->order_by($orderBy, $orderFormat);
    ...
    */
     ...
     * @return boolean
     */
    public function add($itemName, $itemQuantity, $itemPrice, $costPrice, $itemDescription, $itemCode, $itemUrduName, $itemLocation){
        $data = ['name'=>$itemName, 'quantity'=>$itemQuantity, 'costPrice'=>$costPrice, 'unitPrice'=>$itemPrice, 'description'=>$itemDescription, 'code'=>$itemCode, 'urduName'=>$itemUrduName, 'location'=>$itemLocation];
    ...
    */
     ...
     * @return boolean
     */
    public function logsearch($value){
        $q = "SELECT * FROM eventlog 
            WHERE 
            itemName LIKE '%".$this->db->escape_like_str($value)."%'
            || 
            eventItemCodeOrRef LIKE '%".$this->db->escape_like_str($value)."%'";
