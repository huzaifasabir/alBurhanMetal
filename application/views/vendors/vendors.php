...
<div class="pwell hidden-print">   
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="col-sm-2 form-inline form-group-sm">
                        <button class="btn btn-primary btn-sm" id='createVendor'>Add New Vendor</button>
                    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="col-sm-4 hidden" id='createNewVendorDiv'>
                <div class="well">
                    <button class="close cancelAddVendor">&times;</button><br>
                    <form name="addNewVendorForm" id="addNewVendorForm" role="form">
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group-sm">
                                ...
                                <input type="text" id="companyName" name="companyName" placeholder="Company Name" maxlength="80"
                                    class="form-control" onchange="checkField(this.value, 'companyNameErr')" autofocus>
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group-sm">
                                ...
                                <input type="email" id="email" name="email" placeholder="Email" maxlength="80" class="form-control" onchange="checkField(this.value, 'salesRepresentativeErr')">
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group-sm">
                                ...
                                <input type="text" id="outstandingBalance" name="outstandingBalance" placeholder="Outstanding Balance (Optional)" class="form-control"
                                    >
