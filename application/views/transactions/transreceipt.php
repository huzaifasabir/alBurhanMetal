...
<div id="transReceiptToPrint">
    <div class="row">
        <div class="col-xs-12 text-center text-uppercase">
            ...
            <b>1410 Store, city saddar road</b>
            <div>+92 3325136396 , 0515773930</div>
        </div>
    </div>
	...
	<div class="row" style='font-weight:bold'>
        ...
        <div class="col-xs-3">Urdu</div>
		<div class="col-xs-3">QtyxPrice</div>
		<div class="col-xs-3">Tot(&#8358;)</div>
	</div>
	<hr style='margin-top:2px; margin-bottom:0px'>
    <?php $init_total = 0; ?>
    <?php foreach($allTransInfo as $get):?>
        <div class="row">
            <div class="col-xs-3"><?=ellipsize($get['itemName'], 100);?></div>
            <div class="col-xs-3"><?=ellipsize($get['urduName'], 100);?></div>
            <div class="col-xs-3"><?=$get['quantity'] . "x" .number_format($get['unitPrice'])?></div>
            <div class="col-xs-3"><?=number_format($get['totalPrice'])?></div>
        </div>
    ...
    <br>
    <div class="row">
        <div class="col-xs-12 text-center">Thanks for your shopping with us</div>
    </div>
</div>
