...
if(isset($transInfo) && !empty($transInfo)){    
    foreach($transInfo as $get){
        ...
        $transInfo_array[$get['transId']] = [$quantity];
    }
}
                ...
                <div class="col-sm-12" id="salesTransFormDiv">
                    <div class="well">
                        ...
                        <form name="salesTransForm" id="salesTransForm" role="form" >
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="row hidden" id="customerDiv">
                                        <div class="col-sm-4 form-group-sm">
                                <label for="customer">Customer</label>
                                <select id="customer" name="" class="form-control selectedCustomerDefault" onchange="">
                                    <option value="<?= $transInfo[0]['cust_id']?>"><?= $transInfo[0]['cust_name']?></option>
                            ...
                            <div class="col-sm-2 form-group-sm">
                                ...
                                <input class="form-control selectedNewCustomer" type="checkbox" id="newCustomer" name="newCustomer" value="1">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 form-group-sm">
                                            ...
                                            <input type="text" min="0" id="discountValue" class="form-control" value="0">
                                        </div>
                                        <div class="col-sm-4 form-group-sm">
...
<script src="<?=base_url()?>public/js/editTransaction.js"></script>
