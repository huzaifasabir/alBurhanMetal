                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <div style="font-size:100px">
                                <h1><img src="<?=base_url()?>public/images/alburhan.png" alt="1410-logo" height="150px"></h1>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="form-bottom">
                                <form id="loginForm">
                                    <div class="form-group">
                                        ...
                                        <input type="username" placeholder="Username" class="form-control checkField" id="username" >
                                    </div>
                                    <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-center" style="color:white">
                            Designed and Developed by <a href="" target='_blank' class="text-primary">Huzaifa Sabir</a> (2019)
                        </div>
                    </div>
                </div>
            </div>
