    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="col-sm-12" id="itemsListDiv">
                <!-- Item list Table-->
                <div class="row">
                    <div class="col-sm-12" id="purchaseListTable"></div>
                </div>
                <div class="row">
                    <div class="col-sm-2">
                    <button class="btn btn-primary btn-sm" id="print" onclick="printDiv('purchaseListTable')">Print</button></div>
                </div> 
                <!--end of table-->
            </div>
...
<!--end of modal-->
<script src="<?=base_url()?>public/js/products/purchaseReturn.js"></script>