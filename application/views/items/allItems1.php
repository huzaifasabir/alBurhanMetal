        ...
        <div class="col-sm-12">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <a href="<?= site_url('items/export_csv')?>" target="blank">Export</a><br><br>
                    ...
                    <div class="col-sm-3 form-inline form-group-sm">
                        ...
                        <input type="search" id="itemSearchAll" class="form-control" placeholder="Search Items">
                    </div>
        ...
        <div class="col-sm-12">
            ...
            <div class="col-sm-12" id="itemsListDiv">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                    <button class="btn btn-primary btn-sm" id="print" onclick="printWithoutCost()">Without Cost</button></div>
                </div>
