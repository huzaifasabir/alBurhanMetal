                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3 form-group-sm">
                                            ...
                                            <span id="vendor" class="form-control staticlabel"></span>
...
<div class="row">
    ...
    <div class="col-sm-2 form-group-sm">
        ...
        <span class="form-control itemPrice staticlabel">0.00</span>
    </div>
    ...
    <div class="col-sm-2 form-group-sm">
        ...
        <span class="form-control totalPrice staticlabel">0</span>
    </div>
...
<!--end of modal-->
<script src="<?=base_url()?>public/js/products/returnPurchaseOrder.js"></script>