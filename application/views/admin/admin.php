                ...
                <form id='addNewAdminForm' name='addNewAdminForm' role='form'>
                    <div class="row">
                        <div class="form-group-sm col-sm-6">
                            ...
                            <input type="text" id='fullName' class="form-control checkField" placeholder="Full Name">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group-sm col-sm-6 hidden">
                            <label for="passwordDup" class="control-label">Retype Password:</label>
                            <input type="password" class="form-control checkField" id="passwordDup1" placeholder="Retype Password">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id='editAdminForm' name='editAdminForm' role='form'>
                    <div class="row">
                        <div class="form-group-sm col-sm-6">
                            <label for='fullNameEdit' class="control-label">Full Name</label>
                            <input type="text" id='fullNameEdit' class="form-control checkField" placeholder="Full Name">
                            <span class="help-block errMsg" id="fullNameEditErr"></span>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group-sm col-sm-6">
                            ...
                            <input type="text" id='usernameEdit' class="form-control checkField" placeholder="username">
                            <span class="help-block errMsg" id="usernameEditErr"></span>
                        </div>
                        <div class="form-group-sm col-sm-6">
