        ...
        <div class="panel panel-info">
            <div class="panel-body latestStuffsBody" style="background-color: #5cb85c">
                ...
                <div class="pull-right">
                    ...
                    <div class="latestStuffsText">Batches in Process</div>
                </div>
            </div>
            <div class="panel-footer text-center" style="color:#5cb85c">Number of Batches Pending</div>
        </div>
    </div>
    <div class="col-sm-4">
        <div class="panel panel-info">
            <div class="panel-body latestStuffsBody" style="background-color: #f0ad4e">
                ...
                <div class="pull-right">
                    ...
                    <div class="latestStuffsText pull-right">Total No. of Batches Produced</div>
                </div>
            </div>
            <div class="panel-footer text-center" style="color:#f0ad4e">All-time Total Batches</div>
        </div>
    </div>
    <div class="col-sm-4">
        <div class="panel panel-info">
...
<div class="row margin-top-5">
    <div class="col-sm-6">
        <div class="panel panel-hash">
            <div class="panel-heading"><i class="fa fa-cart-plus"></i> LOW QUANTITY</div>
            ...
            <table class="table table-striped table-responsive table-hover">
                ...
                <tbody>
                <?php foreach($lowQuantity as $get):?>
                    <tr>
                        <td><?=$get->name?></td>
                        <td><?=$get->qty?></td>
                    </tr>
            ...
            <table class="table table-striped table-responsive table-hover">
                ...
                <?php foreach($highestEarners as $get):?>
                    <tr>
                        ...
                        <td>Rs <?= number_format($get->totEarned - $get->cost, 2) ?></td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
