        ...
        <div class="col-sm-12">
            ...
            <div class="col-sm-10 " id='createNewItemDiv'>
                <div class="well">
                    ...
                    <form name="addNewItemForm" id="addNewItemForm" role="form" method="post" action="<?php echo site_url()?>/add-outgoing-post">
                        ...
                        <div class="row" id="amountDiv">
                            <div class="col-sm-12 form-group-sm">
                                ...
                                <input type="text" id="amount" name="amount" placeholder="Amount in Rs"
                                    class="form-control amountRs" min="0" required onchange="checkAmountField()">
