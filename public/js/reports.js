...
$(document).ready(function(){
    ...
    $("#clickToGen1").click(function(){
        ...
        if(!from){
            $("#transFromErr").html("Required");
            return;
        }else{
            $("#transFromErr").html("");
        }
        if(!to){
            $("#transToErr").html("Required");
            return;
        }else{
            $("#transToErr").html("");
        }
                ...
                $.ajax({
                    url: appRoot+"reports/incomeStatement",
                    method: "get",
                    ...
                    success:function(returnedData){
                        if(returnedData.status === 1){
                            ...
                            //display receipt
                            $("#incomeTable1").html(returnedData.ouputTable);//paste receipt
    ...
    $("#clickToGenRent").click(function(){
        ...
        console.log(rentS);
                ...
                $.ajax({
                    url: appRoot+"reports/rentReport",
                    method: "get",
                    data: {from:from,to:to, rentS:rentS},
                    ...
                    success:function(returnedData){
                        if(returnedData.status === 1){
                            ...
                            console.log(returnedData.ouputTable);
    ...
    $("#clickToGenDaily").click(function(){
        ...
        if(!from){
            ...
            $("#transFromErr").html("");
                ...
                $.ajax({
                    url: appRoot+"reports/getDailyReport",
                    method: "get",
                    data: {from:from},
    ...
    //handles the submission of a new sales order
    $("#clickToGenFinancial").click(function(){
        ...
        if(!to){
            ...
            $("#transToErr").html("");
                ...
                $.ajax({
                    url: appRoot+"reports/financialStatement",
                    method: "get",
                    data: {from:from,to:to},
                    ...
                    success:function(returnedData){
                        if(returnedData.status === 1){
                            ...
                            //display receipt
                            $("#financialTable1").html(returnedData.ouputTable);//paste receipt
...
function latr_(url){
    ...
    $.ajax({
        ...
        success: function(returnedData){
            ...
            $("#transListTable").html(returnedData.transTable);
            console.log(returnedData.expenses);
        },
