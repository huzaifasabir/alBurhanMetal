...
var appRoot = setAppRoot("AlBurhanMetal", "AlBurhanMetal");
...
for (i = 0; i < dropdown.length; i++) {
  ...
  dropdownContent.style.display = "block";
    ...
    $("#purchaseListTable1").on('click', '.vtrP', function(){
        vtrP(this);
        //console.log("here");
    });
    $("#purchaseListTable1").on('click', '.vtrPR', function(){
        vtrPR(this);
        //console.log("here");
    });
    $("#transListTable").on('click', '.vICr', function(){
        vICr(this);
    });

    $("#purchaseListTable1").on('click', '.vICr', function(){
        vICr(this);
        console("her");
    });
    $("#purchaseListTable2").on('click', '.vtr', function(){
        vtr_(this);
        console.log("here");
    });
    $("#purchaseListTable2").on('click', '.vtrR', function(){
        vtrR(this);
        //console.log("here");
    });
    
    $("#purchaseListTable2").on('click', '.vICr', function(){
        vICr(this);
        console("her");
    });
    $("#ledger").on('click', '.vICr', function(){
        console.log("here");
        vICr(this);
    });

    $("#incomingCash").on('click', '.vICr', function(){
        console.log("here");
        vICr(this);
    });
    $("#outgoingCash").on('click', '.vICr', function(){
        console.log("here");
        vICr(this);
    });
    $("#transListTable").on('click', '.vtrR', function(){
        vtrR(this);
    });

    $("#purchaseListTable").on('click', '.vtrP', function(){
        vtrP(this);
    });
    $("#purchaseListTable").on('click', '.vtrPR', function(){
        vtrPR(this);
    });
    ...
    $("#loginModalSubmit").click(function(e){
       ...
       if(!username || !password){
           ...
           $("#logInModalFMsg").css('color', 'red').html("Please enter both your username and password");
           return;
       }
...
function vtr_(elem){
    ...
    if(ref){
        ...
        //$.post(appRoot + "/transactions/vtr_", {ref:ref}, function (data) {  
         //           alert(data);  
         //           });
        //make server request
        $.ajax({
...
function handleLogin(username, password, callback){
    ...
    $.ajax(appRoot+'home/login', {
        ...
        if(returnedData.status === 1){
            ...
            console.log(returnedData.temp1);
            //display error messages
            jsonToReturn = {status:0, msg:"Invalid username/password combination"};
        }
...
function checkBrowserOnline(changeFlashContent){
    if((!navigator.onLine) && (appRoot.search('localhost') === -1)){
        ...
        changeFlashContent ? 
            changeFlashMsgContent('Oops! Bug? Unable to process your request hello. Please try again or report error', '', 'red', '', false) 
            : 
...
function printDiv(id) { 
            ...
            var a = window.open('appRoot', 'Print', strWindowFeatures); 
            a.document.write('<html> <link rel="shortcut icon" href="<?=base_url()?>public/images/icon.ico">');
            a.document.write('<link rel="stylesheet" href="<?=base_url()?>public/bootstrap/css/bootstrap.min.css">'); 
            a.document.write('<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">');
            a.document.write('<link rel="stylesheet" href="<?= base_url() ?>public/css/main.css"><style type="text/css">table{font-size: 10px;}</style>');
            a.document.write('<body ><br><div class="col-xs-12" style="font-size:10px;">'); 
            a.document.write(divContents); 
            a.document.write('</div><button class="btn btn-primary btn-sm hidden-print" onclick="window.print()">Print Report</button>');
...
function printDiv1(id) { 
            ...
            a.document.write('<link rel="stylesheet" href="<?=base_url()?>public/bootstrap/css/bootstrap.min.css">'); 
            a.document.write('<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">');
            a.document.write('<link rel="stylesheet" href="<?= base_url() ?>public/css/main.css"><style type="text/css">table{font-size: 18px;}</style>');
            a.document.write('<body ><br><div class="col-xs-12" style="font-size:18px;">'); 
            a.document.write(divContents); 
            a.document.write('</div><button class="btn btn-primary btn-sm hidden-print" onclick="window.print()">Print Report</button>');
            a.document.write('</body></html>'); 
            a.document.close();  
}
function printDivHalf(id) { 
            ...
            a.document.write('<link rel="stylesheet" href="<?=base_url()?>public/bootstrap/css/bootstrap.min.css">'); 
            a.document.write('<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">');
            a.document.write('<link rel="stylesheet" href="<?= base_url() ?>public/css/main.css">');
            a.document.write('<body ><br><div class="row"><div class="col-xs-6">'); 
            a.document.write(divContents); 
            a.document.write('</div></div><button class="btn btn-primary btn-sm hidden-print" onclick="window.print()">Print Report</button>');
            a.document.write('</body></html>'); 
            a.document.close();  
} 


function printDivLedger(id) { 
            ...
            //console.log($("#ledger tr:first"));
            $("#ledger tr:first").removeClass("hidden-print");
            //a.print(); 
            var divContents = document.getElementById(id).innerHTML;
            //console.log(divContents); 
            var strWindowFeatures = "width=1000,height=500,scrollbars=yes,resizable=yes";
...
function printDivAccountLedger(id) { 
