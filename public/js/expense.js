...
$(document).ready(function(){
    ...
    $("#itemSearch").keyup(function(){
        ...
        if(value){
            $.ajax({
                url: appRoot+"search/expensesearch",
                type: "get",
    ...
    $("#search12").click(function(){
        ...
        if(d1 && d2){
            $.ajax({
                url: appRoot+"search/expenseSearchDate",
                type: "get",
                data: {v:value,flag:flag, d1:d1, d2:d2},
                success: function(returnedData){
                    $("#itemsListTable").html(returnedData.itemsListTable);
                }
            });
    ...
    $("#category").change(function(){
        ...
        if(category){
            $.ajax({
                url: appRoot+"search/itemSearchHomeExpense",
                type: "get",
...
function lilt(url){
    ...
    $.ajax({
        type:'get',
        url: url ? url : appRoot+"expenses/lilt/",
        ...
        success: function(returnedData){
            ...
            $("#itemsListTable").html(returnedData.itemsListTable);
            //console.log("noe");
            //console.log(returnedData.allItems);
        },
