...
$(document).ready(function(){
    ...
    $("#clickToClone").on('click', function(e){
        ...
        cloned.find(".itemTotalPrice").val("0.00");
    ...
    $("#appendClonedDivHere").on("change", ".itemTotalPrice", function(e){
        e.preventDefault();
    ...
    $(".transItemList").each(function(){
        ...
        var itemTotalPrice = ($(this).find(".itemTotalPrice").val());//parseFloat(($(this).find(".itemUnitPrice").val()) * transQty);
        var c = itemTotalPrice.split(',');
        var d = c.join('');
        itemTotalPrice =  parseInt(d);
        var itemUnitPrice1 = itemTotalPrice / transQty;
        $(this).find(".itemUnitPrice").val((itemUnitPrice1));
    ...
    $("#confirmSaleOrder").click(function(){
        ...
        if(invoiceTotal === 0){
            ...
            for(var i = 0; i < selectedItemNodeLength; i++){
                ...
                var totalPrice = (totalPriceNode.value);
...
function ceipacp(){
    ...
    $(".transItemList").each(function(){
        ...
        //else{//if all is well
            ...
            $(this).find(".itemTotalPrice").val(addCommas(itemTotalPrice));
    ...
    return new Promise(function(resolve, reject){
        ...
        $("#totalProfit").html(addCommas(totalProfitTransaction));
        ...
        $.ajax({
            ...
            success: function(returnedData){
                if(returnedData.status === 1){
                    ...
                    costUnitPriceElem.innerHTML = parseFloat(returnedData.costPrice);
                    qtyNeededElem.value = 1;
                    totalPriceElem.value = parseFloat(returnedData.sellingPrice);
