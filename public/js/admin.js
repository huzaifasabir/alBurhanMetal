...
$(document).ready(function(){
    ...
    $("#addAdminSubmit").click(function(e){
        ...
        changeInnerHTML(['fullNameErr', 'usernameErr', 'roleErr', 'mobile1Err', 'mobile2Err', 'passwordOrigErr', 'passwordDupErr'],
        "");
        ...
        if(!fullName || !username || !role || !mobile1 || !passwordOrig ){
            !fullName ? changeInnerHTML('fullNameErr', "required") : "";
        ...
        $.ajax({
            ...
            data: {fullName:fullName,username:username, role:role, mobile1:mobile1, mobile2:mobile2,
            ...
            if(returnedData.status === 1){
                ...
                //reset all error msgs in case they are set
                changeInnerHTML(['fullNameErr',  'emailErr', 'roleErr', 'mobile1Err', 'mobile2Err', 'passwordOrigErr', 'passwordDupErr'],
                "");
                ...
                console.log(returnedData.m1);
                console.log(returnedData.e1);
                console.log(returnedData.r1);
                console.log(returnedData.n1);
                ...
                $("#usernameErr").text(returnedData.username);
    ...
    $("#editAdminSubmit").click(function(e){
        ...
        if(formChanges("editAdminForm")){
            ...
            //ensure all required fields are filled
            if(!fullName || !username || !role || !mobile1){
                !fullName ? changeInnerHTML('fullNameEditErr', "required") : "";
                !username ? changeInnerHTML('usernameEditErr', "required") : "";
            ...
            $.ajax({
                ...
                data: {fullName:fullName, username:username, role:role, mobile1:mobile1, mobile2:mobile2, adminId:adminId}
            }).done(function(returnedData){
        ...
        if(value){//search only if there is at least one char in input
            $.ajax({
                ...
                success: function(returnedData){
                    console.log(returnedData.allAdministrators);
                    $("#allAdmin").html(returnedData.allAdministrators);
                },
