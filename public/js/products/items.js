...
$(document).ready(function(){
    ...
    $("#addNewItem").click(function(e){
        ...
        $.ajax({
            ...
            data:{itemName:itemName, category:category, itemDescription:itemDescription, thickness:thickness, itemQuantity:itemQuantity, itemLocation:itemLocation, costPrice:costPrice,  sellingPrice:sellingPrice, vendor:vendor, hlink:hlink},
    ...
    $("#confirmPurchaseOrder").click(function(){
        ...
        if( (!vendor || !date1 || vendorPayable === '0' || cumAmount === '0')){
            ...
            for(var i = 0; i < selectedItemNodeLength; i++){
                ...
                var costPrice = parseInt(costPriceNode.innerHTML);
...
function ceipacp(){
    ...
    $(".transItemList").each(function(){
        ...
        var itemFixedPrice = parseInt($(this).find(".itemFixedPrice").val());
        var itemCostPrice = Math.round(itemFixedPrice + thickMULconst);
